...
abstract class Node
{
    private int extLength = -1; // cache

    protected abstract int calcExtendLength();
    protected final int getExtendLength()
    {
        if (extLength == -1)
        {
...
class RepNode extends Node
{
    ...
    public char getCharAt(int i)
    {
        ...
        {
            return node.getCharAt(i % node.getExtendLength());
        }
        else
        {
            return '0';
...
class SeqNode extends Node
{
    ...
    public char getCharAt(int i)
    {
        ...
        {
            return snd.getCharAt(i - fst.getExtendLength());
        }
        else
        {
            return '0';
